    ...
    $('#submit-code').click((event) => {
        ...
        $.ajax({
            ...
            headers: {
                ...
                'X-RapidAPI-Key': '73d38cf652msh7bb09d2bc596013p11deb3jsned5d73f03baf',
            ...
            success: function(data){
                ...
                $.ajax({
                    type: 'GET',
                    url: "https://judge0-ce.p.rapidapi.com/submissions/"+data.token+"?base64_encoded=false&wait=true",
                    headers: {
                        'Content-Type': 'application/json',
                        'X-RapidAPI-Key': '73d38cf652msh7bb09d2bc596013p11deb3jsned5d73f03baf',
                        'X-RapidAPI-Host': 'judge0-ce.p.rapidapi.com'
